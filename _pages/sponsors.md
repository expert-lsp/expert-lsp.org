...
Donations and sponsorships are handled by the [Erlang Ecosystem Foundation](https://erlef.org/).

If your company would like to donate, please reach out to Dan Janowski at [sponsor+expert@erlef.org](mailto:sponsor+expert@erlef.org).
